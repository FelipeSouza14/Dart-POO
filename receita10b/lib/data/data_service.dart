...
class DataService {
  ...
  void carregar(index) {
    final carregarParametro = [ItemType.coffee, ItemType.beer, ItemType.nation];
  ...
  void ordenarEstadoAtual(String propriedade) {
    ...
    objetosOrdenados = ord.ordenarItensDeModoCrescente(objetos, DecididorJson(propriedade));
